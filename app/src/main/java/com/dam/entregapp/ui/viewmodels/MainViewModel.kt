...
import com.dam.entregapp.ui.LoginActivity
        ...
        if (user != null) {
            user?.let {
                ...
                CoroutineScope(Dispatchers.Main).launch {
                    val userIDs = withContext(Dispatchers.IO) { // ejecutar en hilo secundario
                        // función que obtiene el usuario de la base de datos
                        getUserID(email)
                    }
